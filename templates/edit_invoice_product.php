...
$sql_query = "SELECT * from INVOICE_PRODUCTS 
...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
  <h1 class="page-header">Update Invoice Product</h1>
 
  <form class="col-xs-5" action="scripts/php/update_invoice_product.php" method="post">
